...
$sqll = "SELECT * FROM user WHERE level = 'admin'";
        ...
        <li class="nav-item">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="tambah-apoteker.php"
                >Apoteker</a
              >
            </div>
          </div>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          >
            ...
            <h5 class="mb-0" style="font-weight: 600">Akun</h5>
