        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="heading d-flex justify-content-between">
              <h1 class="h3 mb-4 text-gray-800">Tambah Data Apoteker</h1>
            ...
            <div class="form-box">
              <form action="../proses_tambah_apoteker.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-6">
                    <div class="input-box">
                      ...
                      <input
                        type="text"
                        name="kode_apoteker"
                        placeholder="masukan kode apoteker"
                        required
                      />
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                      ...
                      <input
                        type="number"
                        name="umur_apoteker"
                        placeholder="masukan umur apoteker"
                        required
                      />
                    </div>
                    <div class="input-box">
                      ...
                      <textarea
                        ...
                        cols="30"
                        rows="10"
                        placeholder="masukan alamat apoteker"
                        required
                      ></textarea>
                    </div>
                  </div>
