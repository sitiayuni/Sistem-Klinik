...
if(isset($_GET['id'])){
    ...
    if(!count($data)){
        echo "<script>alert('Data tidak ditemukan pada tabel.');window.location='data-apoteker.php';</script>";
    }
}
        ...
        <li class="nav-item active">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item active" href="tambah-apoteker.php"
                >Apoteker</a
              >
            </div>
          </div>
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="heading d-flex justify-content-between">
              <h1 class="h3 mb-4 text-gray-800">Edit Data Apoteker</h1>
              <a href="data-apoteker.php">
                <button class="btn btn-danger">Batal</button>
              </a>
            </div>

            <div class="form-box">
              <form action="../proses_edit_apoteker.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-6">
                    <div class="input-box">
                      <label>Kode Apoteker</label><br />
                      <input
                        type="text"
                        name="kode_apoteker"
                        value="<?php echo $data['kode_apoteker']; ?>"
                      />
                      <input type="hidden" name="id" value="<?php echo $data['id']; ?>">
                    </div>
                    <div class="input-box">
                      <label>Nama Apoteker</label><br />
                      <input
                        type="text"
                        name="nama_apoteker"
                        value="<?php echo $data['nama_apoteker']; ?>"
                      />
                    </div>
                    <div class="input-box">
                      <label>Umur</label><br />
                      <input
                        type="number"
                        name="umur_apoteker"
                        value="<?php echo $data['umur_apoteker']; ?>"
                      />
                    </div>
                    <div class="input-box">
                      <label>Alamat</label><br />
                      <textarea
                        name="alamat_apoteker"
                        cols="30"
                        rows="10"       
                      ><?php echo $data['alamat_apoteker']; ?></textarea>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="input-box">
                      ...
                      <input
                        type="text"
                        name="nohp_apoteker"
                        value="<?php echo $data['telepon_apoteker']; ?>"
                      />
                    </div>
                    <div class="input-box">
                      ...
                      >
                        <option selected value="<?php echo $data['status']; ?>">Pilih Status</option>
