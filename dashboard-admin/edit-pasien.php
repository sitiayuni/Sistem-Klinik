...
if(isset($_GET['id'])){
    ...
    if(!count($data)){
        echo "<script>alert('Data tidak ditemukan pada tabel.');window.location='data-pasien.php';</script>";
    }
}
        ...
        <li class="nav-item active">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item active" href="data-pasien.php">Lihat Data</a>
            </div>
          </div>
        </li>
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="heading d-flex justify-content-between">
              ...
              <a href="data-pasien.php">
                <button class="btn btn-danger">Batal</button>
              </a>
            </div>

            <div class="form-box">
              <form action="../proses_edit_pasien.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-6">
                    <div class="input-box">
                      ...
                      <input
                        ...
                        value="<?php echo $data['nomor_identitas']; ?>"
                      />
                    ...
                    <div class="input-box">
                      ...
                      <input
                        type="number"
                        name="umur_pasien"
                        value="<?php echo $data['umur_pasien']; ?>"
                      />
                    </div>
                    <div class="input-box">
                      ...
                      >
                        <option selected value="<?php echo $data['jenis_kelamin']; ?>">Pilih Jenis Kelamin</option>
