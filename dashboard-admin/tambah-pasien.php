...
<html lang="en">
  <head>
    ...
    <title>SiAku - Tambah Data Pasien</title>
        ...
        <li class="nav-item active">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item active" href="">Tambah Data</a>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          >
            ...
            <h5 class="mb-0" style="font-weight: 600">Pasien</h5>
          ...
          <div class="container-fluid">
            ...
            <div class="form-box">
              <form action="../proses_tambah_pasien.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-6">
                    <div class="input-box">
