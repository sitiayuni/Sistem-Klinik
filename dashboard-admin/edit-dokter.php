...
if(isset($_GET['id'])){
    ...
    if(!count($data)){
        echo "<script>alert('Data tidak ditemukan pada tabel.');window.location='data-dokter.php';</script>";
    }
}
        ...
        <li class="nav-item active">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item active" href="data-dokter.php">Dokter</a>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          >
            ...
            <h5 class="mb-0" style="font-weight: 600">Dokter</h5>
                  ...
                  <div class="col-6">
                    <div class="input-box">
                      ...
                      <input
                        type="text"
                        name="kode_dokter"
                        value="<?php echo $data['kode_dokter']; ?>"
                        required
                      />
                    ...
                    <div class="input-box">
                      ...
                      <input
                        type="text"
                        name="nama_dokter"
                        value="<?php echo $data['nama_dokter']; ?>"
                        required
                      />
                    </div>
                    <div class="input-box">
                      ...
                      <input
                        type="number"
                        name="umur_dokter"
                        value="<?php echo $data['umur_dokter']; ?>"
                        required
                      />
                    </div>
                    <div class="input-box">
                      ...
                      <textarea
                        ...
                        rows="10"
                        required
                      ><?php echo $data['alamat_dokter']; ?></textarea>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="input-box">
                      ...
                      <input
                        type="text"
                        name="nohp_dokter"
                        value="<?php echo $data['telepon_dokter']; ?>"
                        required
                      />
                    </div>
                    <div class="input-box">
                      ...
                      <select
                        ...
                        name="poli" 
                        value="<?php echo $data['poli']; ?>"
                        required
                      >
                        <option selected value="<?php echo $data['poli']; ?>">Pilih Poli</option>
