<?php
  ...
  if(isset($_GET['id'])){
    ...
    if(!count($data)){
        echo "<script>alert('Data tidak ditemukan pada tabel.');window.location='rekam-medis.php';</script>";
    }
}
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="form-box">
              <form action="../proses_edit_rekam.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-6">
                    <div class="input-box">
                      ...
                      <input
                        ...
                        value="<?php echo $data['no_rekam_medis']; ?>"
                        required
                      />
                    ...
                    <div class="input-box">
                      ...
                      <input
                        ...
                        value="<?php echo $data['suhu_badan']; ?>"
                        required
                      />
                    </div>         
                  </div>
                  <div class="col-6">
                    ...
                    <div class="input-box">
                        ...
                        <textarea
                            ...
                            required
                      ><?php echo $data['keluhan']; ?></textarea>
                    </div>
                    <div class="input-box">
                      <label>Obat</label><br />
                      <select
                        ...
                        required
                      >
                        <option selected value="<?php echo $data['obat']; ?>">Pilih Obat</option>
                        <?php
