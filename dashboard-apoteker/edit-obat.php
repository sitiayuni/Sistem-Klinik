...
if(isset($_GET['id'])){
    ...
    if(!count($data)){
        echo "<script>alert('Data tidak ditemukan pada tabel.');window.location='data-obat.php';</script>";
    }
}
                  ...
                  <div class="col-6">
                    ...
                    <div class="input-box">
                      ...
                      <select
                        ...
                        required
                      >
                        <option selected value="<?php echo $data['kategori']; ?>">Pilih Kategori</option>
